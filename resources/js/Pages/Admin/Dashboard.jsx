        ...
        <AdminLayout>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <Link href="/admin/orders" prefetch="hover" cacheFor="15s" className="text-xs text-amber-600 font-medium mt-4 inline-flex items-center gap-1 hover:text-amber-700 transition-colors">
                        Kelola Pesanan
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <Link href="/admin/insights" prefetch="hover" cacheFor="15s" className="text-xs text-blue-600 font-medium mt-4 inline-flex items-center gap-1 hover:text-blue-700 transition-colors">
                        Kelola Insight
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                    </Link>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <Link href="/admin/portfolios" prefetch="hover" cacheFor="15s" className="text-xs text-emerald-600 font-medium mt-4 inline-flex items-center gap-1 hover:text-emerald-700 transition-colors">
                        Kelola Portofolio
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                    </Link>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link href="/admin/orders" prefetch="hover" cacheFor="15s" className="inline-flex items-center gap-2 px-4 py-2.5 bg-amber-50 text-amber-700 text-sm font-medium rounded-xl hover:bg-amber-100 transition-colors border border-amber-100">
                    ...
                    <Link href="/admin/insights/create" prefetch="hover" cacheFor="15s" className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-50 text-blue-700 text-sm font-medium rounded-xl hover:bg-blue-100 transition-colors border border-blue-100">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                        Tambah Insight
                    </Link>
                    <Link href="/admin/portfolios/create" prefetch="hover" cacheFor="15s" className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-50 text-emerald-700 text-sm font-medium rounded-xl hover:bg-emerald-100 transition-colors border border-emerald-100">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                        Tambah Portofolio
                    </Link>
                </div>
