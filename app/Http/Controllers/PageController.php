...
class PageController extends Controller
{
    ...
    public function insightDetail(Insight $insight): Response
    {
        return Inertia::render('InsightDetail', ['insight' => $insight]);
    }

    public function portfolioDetail(Portfolio $portfolio): Response
    {
        return Inertia::render('PortofolioDetail', ['portfolio' => $portfolio]);
    }
}
